...
pub const REGISTRY: &[CommandSpec] = &[
    ...
    CommandSpec {
        id: "layout.tabname",
        title: "タブに名前を付ける（:tabname 名前）",
        title_en: "Name this tab (:tabname NAME)",
        keys: &[":tabname"],
        mouse: MousePath::Menu("配置"),
        in_palette: true,
    },
    CommandSpec {
        id: "edit.substitute",
        title: "置換（s/古い/新しい/ ・ %s で全体）",
        title_en: "Substitute (s/old/new/, %s for the whole file)",
        keys: &[":s"],
        mouse: MousePath::Menu("編集"),
        in_palette: true,
    },
